...
CREATE TABLE IF NOT EXISTS "kanban_task" (
	...
	"assignee_id" text,
	"creator_id" text,
	"created_at" date DEFAULT '2024-05-02T17:48:34.959Z' NOT NULL,
	"updated_at" date DEFAULT '2024-05-02T17:48:34.959Z' NOT NULL
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "milestone" (
	...
	"description" text,
	"priority" text,
	"due" date DEFAULT '2024-05-02T17:48:34.959Z' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "project" (
	...
	"created_at" date DEFAULT '2024-05-02T17:48:34.958Z' NOT NULL,
	"updated_at" date DEFAULT '2024-05-02T17:48:34.958Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "team" (
	...
	"description" text,
	"owner_id" text NOT NULL,
	"created_at" date DEFAULT '2024-05-02T17:48:34.960Z' NOT NULL,
	"updated_at" date DEFAULT '2024-05-02T17:48:34.960Z' NOT NULL
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "user" (
	...
	"created_at" date DEFAULT '2024-05-02T17:48:34.952Z' NOT NULL,
	"updated_at" date DEFAULT '2024-05-02T17:48:34.956Z' NOT NULL
);
--> statement-breakpoint
