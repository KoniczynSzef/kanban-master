...
CREATE TABLE `kanban_task` (
	...
	`assignee_id` text,
	`creator_id` text,
	`created_at` text DEFAULT '2024-04-17T07:35:54.324Z' NOT NULL,
	`updated_at` text DEFAULT '2024-04-17T07:35:54.324Z' NOT NULL,
...
CREATE TABLE `milestone` (
	...
	`description` text,
	`priority` text,
	`due` text DEFAULT '2024-04-17T07:35:54.325Z' NOT NULL,
	`author_id` text NOT NULL,
	`project_id` text NOT NULL,
	`created_at` text DEFAULT '2024-04-17T07:35:54.325Z' NOT NULL,
	`updated_at` text DEFAULT '2024-04-17T07:35:54.325Z' NOT NULL,
...
CREATE TABLE `project` (
	...
	`created_at` text DEFAULT '2024-04-17T07:35:54.320Z' NOT NULL,
	`updated_at` text DEFAULT '2024-04-17T07:35:54.322Z' NOT NULL,
