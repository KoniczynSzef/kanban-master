...
describe("displayHeader on create team page", () => {
    test("should return a role header for step zero", () => {
        const header = displayHeader(false, 0, "name");

        expect(header.title).toBe(
            "Let's start with your role in the team, name"
        );
        expect(header.description).toBe(
            "Tell us more about yourself by adding your common role"
        );
    ...
    test("should return a team chat link header for step one", () => {
        const header = displayHeader(false, 1, "name");
    ...
    test("should return a name and description header for step two", () => {
        const header = displayHeader(false, 2, "name");
    ...
    test("should return color header for step three", () => {
        const header = displayHeader(false, 3, "name");
